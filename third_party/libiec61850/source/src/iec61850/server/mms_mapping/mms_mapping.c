                             ...
                             MmsValue* value, MmsServerConnection connection)
{
  ...
  *separator = 0;
  ...
  if (self->controlBlockAccessHandler)
  {
    ...
    if (self->controlBlockAccessHandler(self->controlBlockAccessHandlerParameter, clientConnection, ACSI_CLASS_GoCB, ld, ln,
                                        MmsGooseControlBlock_getName(mmsGCB), varName, IEC61850_CB_ACCESS_TYPE_WRITE) == false)
    {
      return DATA_ACCESS_ERROR_OBJECT_ACCESS_DENIED;
    }
  }
    ...
    if (nextSep != NULL)
    {
      ...
      if (self->controlBlockAccessHandler)
      {
        ...
        if (ld)
        {
          ...
          if (ln)
          {
            if (self->controlBlockAccessHandler(self->controlBlockAccessHandlerParameter, clientConnection, ACSI_CLASS_SGCB, ld, ln,
                                                "SGCB", nameId, IEC61850_CB_ACCESS_TYPE_WRITE) == false)
            {
  ...
  *separator = 0;
  ...
  if (mmsGCB)
  {
    ...
    if (self->controlBlockAccessHandler)
    {
      ...
      if (self->controlBlockAccessHandler(self->controlBlockAccessHandlerParameter, clientConnection, ACSI_CLASS_GoCB, ld, ln,
                                          MmsGooseControlBlock_getName(mmsGCB), varName, IEC61850_CB_ACCESS_TYPE_READ) == false)
      {
                            ...
                            MmsServerConnection connection)
{
  ...
  else if (listType == MMS_GETNAMELIST_JOURNALS)
  {
    if (self->listObjectsAccessHandler)
    {
      ...
      allowAccess = self->listObjectsAccessHandler(self->listObjectsAccessHandlerParameter, clientConnection, ACSI_CLASS_LOG,
                                                   ld, ln, objectName, NULL, IEC61850_FC_NONE);
    }
      ...
      if (separator)
      {
            ...
            fc == IEC61850_FC_LG || fc == IEC61850_FC_GO)
        {
          ...
          if (self->listObjectsAccessHandler)
          {
            ...
            allowAccess = self->listObjectsAccessHandler(self->listObjectsAccessHandlerParameter, clientConnection, acsiClass, ld,
            ...
            if (doStart != NULL)
            {
              ...
              if (fc == IEC61850_FC_SP)
              {
                if (!strcmp(str, "SGCB"))
                {
                  ...
                  allowAccess = self->listObjectsAccessHandler(self->listObjectsAccessHandlerParameter, clientConnection, ACSI_CLASS_SGCB,
                                                               ld, ln, str, subObjectName, fc);
              ...
              if (fc == IEC61850_FC_SP)
              {
                if (!strcmp(str, "SGCB"))
                {
                  if (self->controlBlockAccessHandler)
                  {
                    ...
                    if (self->controlBlockAccessHandler(self->controlBlockAccessHandlerParameter, clientConnection, ACSI_CLASS_SGCB, ld, ln,
                                                        str, "", IEC61850_CB_ACCESS_TYPE_READ) == false)
                    {
                      return DATA_ACCESS_ERROR_OBJECT_ACCESS_DENIED;
                    }
                  }
                   ...
                   char * listName, IedServer_DataSetOperation operation)
{
  ...
  if (self->dataSetAccessHandler)
  {
    ...
    accessGranted = self->dataSetAccessHandler(self->dataSetAccessHandlerParameter, clientConnection, operation,
                                               dataSetRef);
  }
    ...
    while (element != NULL)
    {
      ...
      if (entryLd)
      {
        ...
        if (dataSetEntry)
        {
          ...
          MmsValue* dataSetEntryValue = MmsServer_getValueFromCacheEx(self->mmsServer, listEntry->domain, listEntry->variableName,
                                                                      &dataSetEntryVarSpec);
              ...
              if (dataSetEntryVarSpec->type == MMS_ARRAY)
              {
                ...
                if (elementValue)
                {
                  if (dataSetEntry->componentName)
                  {
                    ...
                    MmsValue* subElementValue = MmsVariableSpecification_getChildValue(elementType, elementValue,
