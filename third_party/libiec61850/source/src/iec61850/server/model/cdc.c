...
{
  DataAttribute* analogeValue = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                                IEC61850_CONSTRUCTED, fc, triggerOptions, 0, 0);
...
DataAttribute *
CAC_ValWithTrans_create(const char * name, ModelNode* parent, FunctionalConstraint fc, uint8_t triggerOptions,
                        bool hasTransientIndicator)
{
  DataAttribute* valWithTrans = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                                IEC61850_CONSTRUCTED, fc, triggerOptions, 0, 0);
 ...
 */
DataAttribute *
CAC_Vector_create(const char * name, ModelNode* parent, uint32_t options, FunctionalConstraint fc,
                  uint8_t triggerOptions)
{
  DataAttribute* vector = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                          IEC61850_CONSTRUCTED, fc, triggerOptions, 0, 0);
...
{
  DataAttribute* point = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                         IEC61850_CONSTRUCTED, fc, triggerOptions, 0, 0);
...
{
  DataAttribute* scaling = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                           IEC61850_CONSTRUCTED, IEC61850_FC_CF, TRG_OPT_DATA_CHANGED, 0, 0);

  DataAttribute_create("scaleFactor", (ModelNode *) scaling, IEC61850_FLOAT32, IEC61850_FC_CF, TRG_OPT_DATA_CHANGED, 0,
                       0);
...
{
  DataAttribute* unit = (name == NULL) ? (DataAttribute *)parent : DataAttribute_create(name, parent,
                                                                                        IEC61850_CONSTRUCTED, IEC61850_FC_CF, TRG_OPT_DATA_CHANGED, 0, 0);
...
{
  DataAttribute_create("stVal", (ModelNode *) dataObject, statusType, IEC61850_FC_ST,
                       TRG_OPT_DATA_CHANGED | TRG_OPT_DATA_UPDATE, 0, 0);
...
CDC_MV_create(const char * dataObjectName, ModelNode* parent, uint32_t options, bool isIntegerNotFloat)
{
  ...
  CAC_AnalogueValue_create("mag", (ModelNode *) newMV, IEC61850_FC_MX, TRG_OPT_DATA_CHANGED | TRG_OPT_DATA_UPDATE,
                           isIntegerNotFloat);
...
CDC_HST_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint16_t maxPts)
{
  ...
  DataAttribute_create("hstVal", (ModelNode *) newHST, IEC61850_INT32, IEC61850_FC_ST,
                       TRG_OPT_DATA_CHANGED | TRG_OPT_DATA_UPDATE, maxPts, 0);
...
addAnalogControls(DataObject* parent, uint32_t controlOptions, bool isIntegerNotFloat)
{
  ...
  if(controlModel != CDC_CTL_MODEL_NONE)
  {
    ...
    if(controlModel == CDC_CTL_MODEL_SBO_ENHANCED)
    {
      DataAttribute* sBOw =  DataAttribute_create("SBOw", (ModelNode *) parent, IEC61850_CONSTRUCTED, IEC61850_FC_CO, 0, 0,
                                                  0);
    ...
    DataAttribute* oper =  DataAttribute_create("Oper", (ModelNode *) parent, IEC61850_CONSTRUCTED, IEC61850_FC_CO, 0, 0,
                                                0);
    ...
    if(controlOptions & CDC_CTL_MODEL_HAS_CANCEL)
    {
      DataAttribute* cancel =  DataAttribute_create("Cancel", (ModelNode *) parent, IEC61850_CONSTRUCTED, IEC61850_FC_CO, 0,
                                                    0, 0);
...
DataObject *
CDC_APC_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint32_t controlOptions,
               bool isIntegerNotFloat)
{
...
DataObject *
CDC_BSC_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint32_t controlOptions,
               bool hasTransientIndicator)
{
...
DataObject *
CDC_ISC_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint32_t controlOptions,
               bool hasTransientIndicator)
{
...
DataObject *
CDC_BAC_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint32_t controlOptions,
               bool isIntegerNotFloat)
{
...
CDC_ACD_create(const char * dataObjectName, ModelNode* parent, uint32_t options)
{
  ...
  DataAttribute_create("dirGeneral", (ModelNode *) newACD, IEC61850_ENUMERATED, IEC61850_FC_ST, TRG_OPT_DATA_CHANGED, 0,
                       0);
...
CDC_VSG_create(const char * dataObjectName, ModelNode* parent, uint32_t options)
{
  ...
  DataAttribute_create("setVal", (ModelNode *) newSPG, IEC61850_VISIBLE_STRING_255, IEC61850_FC_SP, TRG_OPT_DATA_CHANGED,
                       0, 0);
...
DataObject *
CDC_SPV_create(const char * dataObjectName, ModelNode* parent, uint32_t options, uint32_t controlOptions,
               uint32_t wpOptions, bool hasChaManRs)
{
