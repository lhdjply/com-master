      ...
      if(stateInModel)
      {
        ...
        else if(indendation == 3)
        {
          ...
          else if(StringUtils_startsWith((char *) lineBuffer, "SMVC"))
          {
            ...
            currentSMVCB = SVControlBlock_create(nameString, currentLN, nameString2, nameString3, confRev, smpMod, smpRate, optFlds,
                                                 (bool) isUnicast);
        ...
        else if(indendation > 3)
        {
          ...
          else if(StringUtils_startsWith((char *) lineBuffer, "DA"))
          {
            ...
            if(sscanf((char *)lineBuffer, "DA(%129s %i %i %i %i %u)", nameString, &arrayElements, &attributeType,
                      &functionalConstraint, &triggerOptions, &sAddr) != 6)
            {
              goto exit_error;
            }
