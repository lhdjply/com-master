...
createAlternateAccessComponent(const char * componentName)
{
  ...
  alternateAccess->list.array = (struct AlternateAccess__Member **) GLOBAL_CALLOC(1,
                                                                                  sizeof(struct AlternateAccess__Member *));
  alternateAccess->list.array[0] = (struct AlternateAccess__Member *) GLOBAL_CALLOC(1,
                                                                                    sizeof(struct AlternateAccess__Member));
  alternateAccess->list.array[0]->present = AlternateAccess__Member_PR_unnamed;

  alternateAccess->list.array[0]->choice.unnamed = (AlternateAccessSelection_t *) GLOBAL_CALLOC(1,
                                                                                                sizeof(AlternateAccessSelection_t));
  ...
  if(separator)
  {
    ...
    alternateAccess->list.array[0]->choice.unnamed->choice.selectAlternateAccess.accessSelection.choice.component.size =
      size;

    alternateAccess->list.array[0]->choice.unnamed->choice.selectAlternateAccess.alternateAccess =
      createAlternateAccessComponent(separator + 1);
  }
  else
  {
...
deleteAlternateAccessComponent(AlternateAccess_t * alternateAccess)
{
  if(alternateAccess->list.array[0]->choice.unnamed->choice.selectAlternateAccess.alternateAccess)
    deleteAlternateAccessComponent(
      alternateAccess->list.array[0]->choice.unnamed->choice.selectAlternateAccess.alternateAccess);
...
createNewVariableSpecification(const char * domainId, const char * itemId, const char * componentName,
 ...
 */
int
mmsClient_createReadRequestComponent(uint32_t invokeId, const char * domainId, const char * itemId,
                                     const char * component, ByteBuffer* writeBuffer)
{
  MmsPdu_t * mmsPdu = mmsClient_createConfirmedRequestPdu(invokeId);
  ...
  readRequest->variableAccessSpecification.choice.listOfVariable.list.array =
    (ListOfVariableSeq_t **) GLOBAL_CALLOC(1, sizeof(ListOfVariableSeq_t *));
  readRequest->variableAccessSpecification.choice.listOfVariable.list.array[0] = createNewVariableSpecification(domainId,
                                                                                                                itemId, component, false);
  ...
  /* clean up data structures */
  deleteAlternateAccessComponent(
    readRequest->variableAccessSpecification.choice.listOfVariable.list.array[0]->alternateAccess);
                                                ...
                                                uint32_t index, uint32_t elementCount, ByteBuffer* writeBuffer)
{
  ...
  readRequest->variableAccessSpecification.choice.listOfVariable.list.array = (ListOfVariableSeq_t **) GLOBAL_CALLOC(1,
                                                                                                                     sizeof(ListOfVariableSeq_t *));
  readRequest->variableAccessSpecification.choice.listOfVariable.list.count = 1;
...
int
mmsClient_createReadRequestAlternateAccessSingleIndexComponent(uint32_t invokeId, const char * domainId,
                                                               const char * itemId,
