...
static bool
addToOutstandingCalls(MmsConnection self, uint32_t invokeId, eMmsOutstandingCallType type, void * userCallback,
                      void * userParameter, MmsClientInternalParameter internalParameter)
{
  int i = 0;
...
int
mmsMsg_parseConfirmedErrorPDU(uint8_t * buffer, int bufPos, int maxBufPos, uint32_t * invokeId, bool* hasInvokeId,
...
int
mmsMsg_parseRejectPDU(uint8_t * buffer, int bufPos, int maxBufPos, uint32_t * invokeId, bool* hasInvokeId,
                      int * rejectType, int * rejectReason)
{
  int length;
...
static void
handleAsyncResponse(MmsConnection self, ByteBuffer* response, uint32_t bufPos, MmsOutstandingCall outstandingCall,
                    MmsError err)
{
  ...
  else if(outstandingCall->type == MMS_CALL_TYPE_FILE_READ)
  {
    ...
    else
    {
      ...
      if(mmsMsg_parseFileReadResponse(ByteBuffer_getBuffer(response), bufPos, ByteBuffer_getSize(response),
                                      outstandingCall->invokeId, frsmId, &moreFollows,
  ...
  else if(outstandingCall->type == MMS_CALL_TYPE_GET_FILE_DIR)
  {
    ...
    {
      if(mmsClient_parseFileDirectoryResponse(response, bufPos, outstandingCall->invokeId, handler,
                                              outstandingCall->userParameter) == false)
...
MmsConnection_createInternal(TLSConfiguration tlsConfig, bool createThread)
{
  ...
  if(self)
  {
    ...
    self->outstandingCalls = (MmsOutstandingCall) GLOBAL_CALLOC(CONFIG_DEFAULT_MAX_SERV_OUTSTANDING_CALLED,
                                                                sizeof(struct sMmsOutstandingCall));
    ...
    self->isoClient = IsoClientConnection_create(self->isoParameters, (IsoIndicationCallback) mmsIsoCallback,
                                                 (void *) self);
...
MmsConnection_getDomainVariableListNamesAsync(MmsConnection self, uint32_t * usedInvokeId, MmsError* mmsError,
                                              ...
                                              const char * continueAfter, LinkedList result, MmsConnection_GetNameListHandler handler, void * parameter)
{
  mmsClient_getNameListSingleRequestAsync(self, usedInvokeId, mmsError, domainId, MMS_OBJECT_CLASS_NAMED_VARIABLE_LIST,
                                          false,
                                          continueAfter, handler, parameter, result);
}
                                    ...
                                    const char * domainId, const char * itemId, const char * componentId)
{
  ...
  MmsConnection_readVariableComponentAsync(self, NULL, &err, domainId, itemId, componentId, readVariableHandler,
                                           &parameter);
...
static void
readNVLDirectoryHandler(uint32_t invokeId, void * parameter, MmsError mmsError,
...
static void
identifyHandler(uint32_t invokeId, void * parameter, MmsError mmsError, char * vendorName, char * modelName,
                char * revision)
{
  (void)invokeId;
...
static void
getServerStatusHandler(uint32_t invokeId, void * parameter, MmsError mmsError, int vmdLogicalStatus,
                       int vmdPhysicalStatus)
{
  (void)invokeId;
                                   ...
                                   MmsValue* startTime, MmsValue* endTime, bool* moreFollows)
{
  ...
  MmsConnection_readJournalTimeRangeAsync(self, NULL, &err, domainId, itemId, startTime, endTime, readJournalHandler,
                                          &parameter);
                                    ...
                                    MmsValue* timeSpecification, MmsValue* entrySpecification, bool* moreFollows)
{
  ...
  MmsConnection_readJournalStartAfterAsync(self, NULL, &err, domainId, itemId, timeSpecification, entrySpecification,
                                           readJournalHandler, &parameter);
                                         ...
                                         MmsValue* timeSpecification, MmsValue* entrySpecification, MmsConnection_ReadJournalHandler handler, void * parameter)
{
  ...
  mmsClient_createReadJournalRequestStartAfter(invokeId, payload, domainId, itemId, timeSpecification,
                                               entrySpecification);
...
static void
fileOpenHandler(uint32_t invokeId, void * parameter, MmsError mmsError, int32_t frsmId, uint32_t fileSize,
                uint64_t lastModified)
{
  (void)invokeId;
...
static void
fileReadHandler(uint32_t invokeId, void * parameter, MmsError mmsError, int frsmId, uint8_t * buffer,
...
static void
getFileDirHandler(uint32_t invokeId, void * parameter, MmsError mmsError, char * filename, uint32_t size,
                  uint64_t lastModified,
                  bool moreFollows)
{
  (void)invokeId;
                                                   ...
                                                   uint32_t arrayIndex, const char * componentId, MmsValue* value)
{
  ...
  MmsConnection_writeSingleArrayElementWithComponentAsync(self, NULL, &err, domainId, itemId, arrayIndex, componentId,
                                                          value, writeVariableHandler, &parameter);
                                     ...
                                     const char * componentId, MmsValue* value)
{
  ...
  MmsConnection_writeVariableComponentAsync(self, NULL, &err, domainId, itemId, componentId, value, writeVariableHandler,
                                            &parameter);
                                     ...
                                     /* OUTPUT */LinkedList* /* <MmsValue*> */accessResults)
{
  ...
  MmsConnection_writeMultipleVariablesAsync(self, NULL, &err, domainId, items, values, writeMultipleVariablesHandler,
                                            &parameter);
                                 ...
                                 MmsValue* value)
{
  ...
  MmsConnection_writeArrayElementsAsync(self, NULL, &err, domainId, itemId, index, numberOfElements, value,
                                        writeVariableHandler, &parameter);
                                     ...
                                     /* OUTPUT */LinkedList* /* <MmsValue*> */accessResults)
{
  ...
  MmsConnection_writeNamedVariableListAsync(self, NULL, &err, isAssociationSpecific, domainId, itemId, values,
                                            writeMultipleVariablesHandler, &parameter);
