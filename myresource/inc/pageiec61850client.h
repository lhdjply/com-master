...
class PageIEC61850Client : public QMainWindow
{
  ...
  public:
    ...
    // UI getters
    QTreeWidget * getDataModelTreeWidget() const
    {
      return m_dataModelTree;
    }
    QWidget * getDataValueWidget() const
    {
      return m_dataValueWidget;
    }
  ...
  private:
    ...
    QTreeWidgetItem * addDataObject(QTreeWidgetItem* parentItem, const QString& objectName, const QString& objectReference,
                                    int depth = 0);
